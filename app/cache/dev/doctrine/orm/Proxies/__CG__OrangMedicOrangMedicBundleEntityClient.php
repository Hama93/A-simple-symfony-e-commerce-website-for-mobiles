 ...
 */
class Client extends \OrangMedic\OrangMedicBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'sexe', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'mp', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'photo', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'tel', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'status', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'emailClient', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'idAdmin', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Client' . "\0" . 'emailn');
        }
    ...
    public function setEmailn(\OrangMedic\OrangMedicBundle\Entity\Newsletter $emailn = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEmailn', array($emailn));

        return parent::setEmailn($emailn);
    }
    ...
    public function getEmailn()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEmailn', array());

        return parent::getEmailn();
    }
