 ...
 */
class Categorie extends \OrangMedic\OrangMedicBundle\Entity\Categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Categorie' . "\0" . 'nomCategorie', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Categorie' . "\0" . 'libelle');
        }
