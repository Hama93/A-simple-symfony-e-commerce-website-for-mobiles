 ...
 */
class Marque extends \OrangMedic\OrangMedicBundle\Entity\Marque implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Marque' . "\0" . 'nomMarque', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Marque' . "\0" . 'libelle');
        }
