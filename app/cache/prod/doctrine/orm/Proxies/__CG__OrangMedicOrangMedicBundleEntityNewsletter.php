 ...
 */
class Newsletter extends \OrangMedic\OrangMedicBundle\Entity\Newsletter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Newsletter' . "\0" . 'emailn', '' . "\0" . 'OrangMedic\\OrangMedicBundle\\Entity\\Newsletter' . "\0" . 'idAdmin');
        }
